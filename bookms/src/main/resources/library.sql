...
-- ----------------------------
INSERT INTO `book_info` VALUES (10000004, '大雪中的山庄12322', '东野圭吾', '北京十月文艺出版社', '9787530216835', '东野圭吾长篇小说杰作，中文简体首次出版。 一出没有剧本的舞台剧，为什么能让七个演员赌上全部人生.东野圭吾就是有这样过人的本领，能从充满悬念的案子写出荡气回肠的情感，在极其周密曲折的同时写出人性的黑暗与美丽。 一家与外界隔绝的民宿里，七个演员被要求住满四天，接受导演的考验，但不断有人失踪。难道这并非正常排练，而是有人布下陷阱要杀他们。 那时候我开始喜欢上戏剧和音乐，《大雪中的山庄》一书的灵感就来源于此。我相信这次的诡计肯定会让人大吃一惊。', '中文', 35.00, '2017-07-23', 9, 13, 0);
...
INSERT INTO `book_info` VALUES (50000013, '何以笙箫默123test', '顾漫', '朝华出版社', '9787505414709', '1234', '1234', 15.00, '2017-07-23', 9, 13, 1);
INSERT INTO `book_info` VALUES (50000014, '何以笙箫默123test', '顾漫', '朝华出版社', '978757091', '1234', '1234', 15.00, '2017-07-23', 9, 13, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2017090204 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `lend_list` VALUES (2017090202, 10000006, 1706010219, '2017-06-12', '2017-09-02');
INSERT INTO `lend_list` VALUES (2017090203, 10000004, 1706010219, '2017-06-12', '2017-09-02');
...
-- ----------------------------
INSERT INTO `reader_info` VALUES (1706010217, '罗大佑', '男', '1998-09-10', '青海省', '12345678909', 1, 0);
INSERT INTO `reader_info` VALUES (1706010218, '王刚', '男', NULL, '江苏省徐州市', '123456123', 1, 1);
INSERT INTO `reader_info` VALUES (1706010219, '李四', '男', '1999-01-01', '浙江省杭州市', '18888888888', 1, 1);
INSERT INTO `reader_info` VALUES (1706010220, '小华', '男', '1999-08-29', '陕西省西安市', '12345678907', 1, 1);
INSERT INTO `reader_info` VALUES (1706010221, '小红', '女', '1999-01-01', '陕西省西安市', '15123659875', 1, 1);
INSERT INTO `reader_info` VALUES (1706010222, '小刚', '男', '1999-05-03', '山东省青岛市', '15369874123', 1, 1);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '1706010217', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
INSERT INTO `user` VALUES (2, '1706010218', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
INSERT INTO `user` VALUES (3, '1706010219', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
INSERT INTO `user` VALUES (4, '1706010220', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
INSERT INTO `user` VALUES (5, '1706010221', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
INSERT INTO `user` VALUES (6, '1706010222', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
INSERT INTO `user` VALUES (7, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', 1, 1);
INSERT INTO `user` VALUES (13, '1271635062', 'e10adc3949ba59abbe56e057f20f883e', 'user', 1, 1);
